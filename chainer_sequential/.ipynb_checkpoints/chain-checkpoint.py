...
import chainer
import chainer_sequential.sequential
...
#        if isinstance(sequence, sequential.Sequential) == False:
        if isinstance(sequence, chainer_sequential.sequential.Sequential) == False:
            raise Exception()
...
#            elif isinstance(link, sequential.Sequential):
            elif isinstance(link, chainer_sequential.sequential.Sequential):
